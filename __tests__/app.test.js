...
describe('app routes', () => {
  describe('routes', () => {
    ...
    test('returns a new fav added by user 2', async () => {

      const newDrink = {
        name: 'Cosmo',
        drink_id: 99999,
        image: 'http://placekitten.com/200/300',
        mainingredient: 'champagne'
      };
    ...
    test('returns all favs for user 2', async () => {
    ...
    test('removes specific item from favs of user 2', async () => {
    ...
    test('returns no favs for user 2 now that fav has been removed', async () => {
    ...
    test('returns array of Margaritas based on search', async () => {
      ...
      const data = await fakeRequest(app)
        .get('/searchbyname?search=margarita')
        .expect('Content-Type', /json/)
        .expect(200);
    ...
    test('returns array of dinks containing vodka based on search', async () => {
    ...
    test('returns moscow mule by drink id', async () => {
